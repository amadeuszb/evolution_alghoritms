...
public class PopulationMutatorBinary implements PopulationMutator {
    ...
    public PopulationMutatorBinary(Converter converter, Mutator mutator, double mutationProbability, Random random) {
