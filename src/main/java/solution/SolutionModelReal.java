...
public class SolutionModelReal implements SolutionModel {
    ...
    public SolutionModelReal(List<Individual> population, Evaluator evaluator, SelectionMethod selectionMethod,
                             PopulationCrossover populationCrossover, PopulationMutator populationMutator,
                             EliteStrategy eliteStrategy, int selectionCount) {
